...
export const BASS_PRESETS = {
  sub: { label: "Sub Sine", shape: "sine", filter: 420, glide: 0.04, release: 0.22, harmonics: 0 },
  dub: { label: "Dub Triangle", shape: "triangle", filter: 520, glide: 0.08, release: 0.32, harmonics: 0 },
  rubber: { label: "Rubber Saw", shape: "sawtooth", filter: 360, glide: 0.06, release: 0.18, harmonics: 0 },
  square: { label: "Square Bass", shape: "square", filter: 640, glide: 0.03, release: 0.14, harmonics: 0 },
  classic: { label: "Classic", shape: "sine", filter: 420, glide: 0.04, release: 0.22, harmonics: 0.25, harmonicShape: "square", harmonicFilter: 300 },
  punchy: { label: "Punchy", shape: "sine", filter: 380, glide: 0.03, release: 0.18, harmonics: 0.4, harmonicShape: "square", harmonicFilter: 400 },
  growl: { label: "Growl", shape: "sine", filter: 350, glide: 0.05, release: 0.25, harmonics: 0.6, harmonicShape: "sawtooth", harmonicFilter: 500 },
  custom: { label: "Custom", shape: "sine", filter: 520, glide: 0.04, release: 0.2, harmonics: 0 },
};
